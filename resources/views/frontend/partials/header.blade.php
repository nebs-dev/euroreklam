			...
			<div class="content_wrap">
				<div class="columns_wrap columns_fluid no_margins">
					<div class="column-1_3 contact_logo">
						<div class="logo">
							<a href="index.html"><img src="{{ asset('images/logo_euroreklam.jpg') }}" class="logo_main" alt="" width="246" height="52"></a>
						</div>
					</div>
...
<div class="header_mobile">
	<div class="content_wrap">
		...
		<div class="logo">
			<a href="index.html"><img src="{{ asset('images/logo-header.png') }}" class="logo_main" alt="" width="246" height="52"></a>
		</div>
	</div>
	<div class="side_wrap">
